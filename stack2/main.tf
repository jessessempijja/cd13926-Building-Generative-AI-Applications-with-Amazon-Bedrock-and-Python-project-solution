...
module "bedrock_kb" {
  ...
  aurora_arn        = "arn:aws:rds:us-east-1:441610450118:cluster:my-aurora-serverless"
  aurora_db_name    = "myapp"
  aurora_endpoint   = "my-aurora-serverless.cluster-ca1e32g61i5a.us-east-1.rds.amazonaws.com"
  ...
  aurora_secret_arn = "arn:aws:secretsmanager:us-east-1:441610450118:secret:my-aurora-serverless-LZvhRM"
  s3_bucket_arn = "arn:aws:s3:::bedrock-kb-441610450118"
}